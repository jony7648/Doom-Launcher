...
char* getConfigValue(char* key, ParsedConfig* cfgptr) {
...
/*
char* getConfigKey(char* value, int maxCount, ParsedConfig* cfgptr) {
	int retIndex = 0;
...
ParsedConfig* parseConfig(char* path) {
	...
	ParsedConfig* cfgptr = newParsedConfig();
...
/*
int main() {
	ParsedConfig* cfgptr = parseConfig("config.cfg");
